CREATE TABLE [dbo].[CoQs] (
    ...
    [ProductId]                INT            NULL,
    [GrandTotalWeightKg]       FLOAT (53)     CONSTRAINT [DF_CoQs_GrandTotalWeightKg] DEFAULT ((0)) NOT NULL,
    [ShoreFigureMTAirGas]      FLOAT (53)     CONSTRAINT [DF_CoQs_ShoreFigureMTAirGas] DEFAULT ((0)) NOT NULL,
