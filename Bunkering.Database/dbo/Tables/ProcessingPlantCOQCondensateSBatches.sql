CREATE TABLE [dbo].[ProcessingPlantCOQCondensateSBatches] (
    [ProcessingPlantCOQCondensateSBatchId] INT        IDENTITY (1, 1) NOT NULL,
    ...
    CONSTRAINT [PK_ProcessingPlantCOQCondensateSBatches] PRIMARY KEY CLUSTERED ([ProcessingPlantCOQCondensateSBatchId] ASC)
);
