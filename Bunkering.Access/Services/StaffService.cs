...
namespace Bunkering.Access.Services
{
    public class StaffService
    {
        ...
        public async Task<ApiResponse> Dashboard()
        {
            ...
            var allApps = await _userManager.IsInRoleAsync(user, "Company")
                ? await _unitOfWork.Application.Find(x => x.UserId.Equals(user.Id))
                : await _unitOfWork.Application.GetAll();
            //var user = await _userManager.FindByEmailAsync(User);
            //var company = await _userManager.IsInRoleAsync(user, "Company");
            //var appPayment = await _unitOfWork.Application.Find(x => x.UserId.Equals(user.Id));
            //var getAllApps = await _unitOfWork.Application.GetAll();
            //var allApps = company ? appPayment : getAllApps;`
            //var apps = await _userManager.
            //IsInRoleAsync(user, Roles.FAD)
